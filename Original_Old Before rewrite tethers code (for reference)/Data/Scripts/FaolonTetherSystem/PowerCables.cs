...
namespace FaolonTetherSystem.PowerCables
{
    ...
    public class PowerCable : MyGameLogicComponent, IMyEventProxy 
    {
        // =====
        // @VARS
        // =====
        ...
        private const ushort NetworkMessageIdStartPlacing = 58001;
        private const ushort NetworkMessageIdFinishPlacing = 58002;
        private const ushort NetworkMessageIdRemoveCable = 58003;
        ...
        public override void Close()
        {
            ...
            if (block != null)
            {
				Log.Info("Close: " + block.EntityId + " - " + Settings.ConnectedBlockId);																		 
                /*
            ...
            try
            {
                ...
                */
                ...
                if (ConnectedBlockId != -1)
                {
                    ...
                    {
                        retryFindBlock--;
						oldUpdate = NeedsUpdate;
                        NeedsUpdate = MyEntityUpdateEnum.BEFORE_NEXT_FRAME;
                        Log.Info("BeforeFrame retry: " + block.EntityId);
                        return;
                    }
						NeedsUpdate = oldUpdate;
